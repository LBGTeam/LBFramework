    ...
    public class FileMgr : Singleton<FileMgr>
    {
        ...
        private Stream OpenStreamInZip(string absPath)
        {
	        ...
	        if (zipEntry != null)
		        ...
		        LBLogWrapper.LogError(string.Format("Can't Find File {0}", absPath));
	        return null;
        }
        //得到压缩包里的文件
        ...
        private byte[] ReadDataInAndriodApk(string fileRelativePath)
        {
	        ...
	        if (mZipFile == null)
	        {
		        LBLogWrapper.LogError("can't open apk");
		        return null;
	        }
	        ...
	        {
		        LBLogWrapper.LogError(string.Format("Can't Find File {0}", fileRelativePath));
	        }
